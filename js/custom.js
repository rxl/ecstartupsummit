...
//INITIALIZES TWITTER FEED PLUGIN
	...
	$('#twitter-feed').tweet({
		username: "princetoneclub",  //just enter your twitter username
		join_text: "auto",
		avatar_size: null,
...
//NAVIGATION
	...
	$('#navigation1').localScroll();
	$('#navigation1 li a').click( function () {
		$('#navigation1 li a').removeClass("active");
		$('#navigation2 li a').removeClass("active");
		$(this).addClass("active");
	});
	
	$('#navigation2').localScroll();
	...
	$('#logo h1 a').click(function(){ 		
		$('#navigation1 li a').removeClass("active");
		$('#navigation2 li a').removeClass("active");
		$('#navigation1 li:first a').addClass("active");
